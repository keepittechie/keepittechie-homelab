...
| 5. Proxmox VM Layout | Explain VM role separation | Why virtualization helps with isolation, testing, and rebuilds | `services/proxmox/README.md`, `docs/hardware.md` | Show a sanitized VM role table |
